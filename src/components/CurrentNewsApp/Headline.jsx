...
export function Headline() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://newsapi.org/v2/everything?q=tesla&from=2022-09-17&sortBy=publishedAt&apiKey=846fd227de084ee2ae29d9474c3e1a43`
      )
      .then(({ data }) => {
        console.log({ data });
    ...
    <div className="Main_Container">
      <div className="News-search">
        ...
        <form className="Head_Input_Area">
          ...
          />
          <button className="Search_Btn" onChange={handleChange}>
            Search
          </button>
        </form>
      </div>
